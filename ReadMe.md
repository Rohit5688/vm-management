...
2. Build project
3. Run "/vm-management/src/main/java/com/vm/management/vmmanagement/VmManagementApplication.java" as Java Application or Run maven install it will create jar, then you can run jar using java- jar location/to/jar
